...
class PromotionsControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create promotion" do
    assert_difference("Promotion.count") do
      post promotions_url, params: { promotion: { discount_percentage: @promotion.discount_percentage, end_date: @promotion.end_date, name: @promotion.name, restaurant_id: @promotion.restaurant_id, start_date: @promotion.start_date } }
    end
  ...
  test "should update promotion" do
    patch promotion_url(@promotion), params: { promotion: { discount_percentage: @promotion.discount_percentage, end_date: @promotion.end_date, name: @promotion.name, restaurant_id: @promotion.restaurant_id, start_date: @promotion.start_date } }
