...
class IngredientsControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create ingredient" do
    assert_difference("Ingredient.count") do
      post ingredients_url, params: { ingredient: { name: @ingredient.name, quantity: @ingredient.quantity, unit: @ingredient.unit } }
    end
  ...
  test "should update ingredient" do
    patch ingredient_url(@ingredient), params: { ingredient: { name: @ingredient.name, quantity: @ingredient.quantity, unit: @ingredient.unit } }
